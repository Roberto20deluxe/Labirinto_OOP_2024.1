    ...
    public void checkTile(Entity entity) {
        ...
        switch (entity.direction) {
            case "up":
                ...
                if (entityTopRow >= 0 && entityTopRow < gp.tileM.mapTileNum[0].length &&
            ...
            case "down":
                ...
                if (entityBottomRow >= 0 && entityBottomRow < gp.tileM.mapTileNum[0].length &&
                    entityLeftCol >= 0 && entityLeftCol < gp.tileM.mapTileNum.length &&
                    entityRightCol >= 0 && entityRightCol < gp.tileM.mapTileNum.length) {
            ...
            case "right":
                ...
                if (entityRightCol >= 0 && entityRightCol < gp.tileM.mapTileNum.length &&
                    entityTopRow >= 0 && entityTopRow < gp.tileM.mapTileNum[0].length &&
                    entityBottomRow >= 0 && entityBottomRow < gp.tileM.mapTileNum[0].length) {
